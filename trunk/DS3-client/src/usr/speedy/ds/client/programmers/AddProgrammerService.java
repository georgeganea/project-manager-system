 ...
 * 
 */
@WebServiceClient(name = "AddProgrammerService", targetNamespace = "http://ds.speedy.usr/", wsdlLocation = "http://localhost:8083/DS3/hire?wsdl")
public class AddProgrammerService
    extends Service
{

    private final static URL ADDPROGRAMMERSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(usr.speedy.ds.client.programmers.AddProgrammerService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = usr.speedy.ds.client.programmers.AddProgrammerService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8083/DS3/hire?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8083/DS3/hire?wsdl', retrying as a local file");
